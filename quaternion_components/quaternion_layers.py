...
class QuaternionLinear(Module):
    ...
    def __init__(self, in_features, out_features, bias=True,
        ...
        self.r_weight = Parameter(torch.ones(self.in_features, self.out_features))
        self.i_weight = Parameter(torch.zeros(self.in_features, self.out_features))
        self.j_weight = Parameter(torch.zeros(self.in_features, self.out_features))
        self.k_weight = Parameter(torch.zeros(self.in_features, self.out_features))
